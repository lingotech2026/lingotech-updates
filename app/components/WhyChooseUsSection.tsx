        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((feature, idx) => (
            <ScrollReveal key={idx} animation="up" delay={idx * 100}>
              <div className="group relative bg-[#F8FAFC] p-6 interactive-card h-full shadow-[0_2px_8px_rgba(15,23,42,0.01)] hover:shadow-[0_12px_24px_rgba(11,60,145,0.05)]">
                {/* Large faded numbers */}
                <div 
                ...
                <h3 className="text-slate-900 mb-3 text-base font-bold uppercase tracking-wide relative z-10">{feature.title}</h3>
